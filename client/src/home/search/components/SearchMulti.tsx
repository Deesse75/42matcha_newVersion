      ...
      <form className='search_advance_form' onSubmit={handleSubmit}>
        <div className='search_advance_top'>
          <div className='search_advance_label'>
            ...
            <div className='search_advance_label_text'>Note de popularité</div>
            <div className='search_advance_label_text'>Avec photo</div>
            <div className='search_advance_label_text'>Avec annonce</div>
          </div>
          <div className='search_advance_choice'>
            ...
            <div className='search_advance_choice_value'>
              <input type='checkbox' name='withPhoto' id='withPhoto' />
            </div>
            <div className='search_advance_choice_value'>
              <input type='checkbox' name='withBio' id='withBio' />
            </div>
          </div>
        </div>
