...
const AuthInputRules: FC<Props> = ({ type }) => {
  return (
    <>
      <div>
          {(type === 'firstname' || type === 'lastname') && (
            <>
              ...
              <div>
                &#11824; &#8200; Contenir entre 3 et 30 caractères inclus
              </div>
          ...
          {type === 'password' && (
            <>
              ...
              <div>&#11824; &#8200; commencer par une lettre</div>
              <div>
                &#11824; &#8200; Contenir entre 8 et 30 caractères inclus
              </div>
              <div>
          ...
          {type === 'birthdate' && (
            <>
              ...
              <div>&#11824; &#8200; Vous devez avoir entre 18 et 120 ans inclus</div>
            </>
          )}
      </div>
    </>
