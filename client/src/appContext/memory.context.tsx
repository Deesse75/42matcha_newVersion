...
import { MiniProfileFrontType, OpenChatListType } from '../appConfig/interface';

type MemoryContextType = {
  listingName: string | null;
  setListingName: React.Dispatch<React.SetStateAction<string | null>>;
  listing: MiniProfileFrontType[] | null;
  setListing: React.Dispatch<React.SetStateAction<MiniProfileFrontType[] | null>>;
...
const MemoryProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [listing, setListing] = useState<MiniProfileFrontType[] | null>(null);
